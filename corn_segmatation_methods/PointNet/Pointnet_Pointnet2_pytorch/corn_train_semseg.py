...
def parse_args():
    ...
    parser.add_argument('--root', type=str, default='/home/yangxin/datasets/3d_corn/miao_corn/deformed/20230216/', help='data root dir')
...
def main(args):
    ...
    log_string(args)
    # root = '/home/yangxin/datasets/3d_corn/miao_corn/deformed/20230219_aug/'
    ...
    TRAIN_DATASET = CornDataset(split='train', data_dir=data_dir, meta=meta, root=root, npoints=NUM_POINT)
    print("start loading test data ...")
    TEST_DATASET = CornDataset(split='val', data_dir=data_dir, meta=meta, root=root, npoints=NUM_POINT)
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for i, (points, target, id) in tqdm(enumerate(trainDataLoader), total=len(trainDataLoader), smoothing=0.9):
            optimizer.zero_grad()
