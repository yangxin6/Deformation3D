        ...
        for i, batch in enumerate(dataloader):
            ...
            if (epoch > cfg.prepare_epochs):
                ...
                clusters_post, semantic_pred_post, cluster_semantic_id_post, cluster_scores_post = \
                    post_process(clusters, semantic_pred, batch['locs_float'], cluster_scores.cpu().numpy(), npoint_th=100)
...
def test_all():
    ...
    if model_name == 'hais':
        from model.hais.hais3 import HAIS as Network
        from model.hais.hais3 import model_fn_decorator
